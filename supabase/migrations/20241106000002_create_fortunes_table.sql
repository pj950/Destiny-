...
COMMENT ON COLUMN fortunes.draw_date IS 'Date when the fortune was drawn (one per day per user)';
...
COMMENT ON COLUMN fortunes.ai_analysis IS 'AI-generated interpretation using Google Gemini';